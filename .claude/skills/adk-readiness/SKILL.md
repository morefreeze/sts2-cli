---
name: adk-readiness
description: "Use when the user wants to scan the repository for AI Coding readiness, assess TTADK/SDD readiness, or generate a maturity report with improvement suggestions; do not use for implementation or document editing."
---

# ADK Readiness

This skill is used to scan repository AI Coding readiness and TTADK readiness. It is suitable for producing a structured maturity report with targeted improvement suggestions.

## Manual Trigger Constraints

- Use this skill only when the user explicitly wants to scan readiness, assess AI Coding preparedness, check TTADK/SDD infrastructure, or generate a readiness report.
- This skill is a read-only assessment tool. It does not implement features or directly modify the repository.
